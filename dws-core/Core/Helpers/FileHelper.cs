...
namespace Core.Helpers
{
    public class FileHelper
    {
        ...
        public static bool CopyToPath(string sourceFileFullPath, string destinationFullPath)
        {
            bool retVal = false;
            if (File.Exists(sourceFileFullPath))
            {
                try
                {
                    string destFullDirectoryPath = Path.GetDirectoryName(destinationFullPath);
                    if (!Directory.Exists(destFullDirectoryPath))
                    {
                        Directory.CreateDirectory(destFullDirectoryPath);
                    }
                    File.Copy(sourceFileFullPath, destinationFullPath);
                    retVal = true;
                }
                catch (Exception ex)
                {
        ...
        public static bool MoveToPath(string sourceFileFullPath, string destinationFullPath)
        {
            bool retVal = false;
            if (File.Exists(sourceFileFullPath))
            {
                try
                {
                    ...
                    File.Move(sourceFileFullPath, destinationFullPath);
                    retVal = true;
                }
                catch (Exception ex)
                {
        ...
        public static bool ReplaceNewFileWithNew(string oldFilePath, string newFilePath)
        {
            bool retVal = false;
