...
namespace QTimes.api.Commands.Reservation.EditReservation
{
    public class EditReservationCommand : ICommand<EditReservationRequest>
    {
        ...
        public EditReservationCommand(IGenericRepository<QTimesContext, core.dal.Models.Reservation> reservationRepository,
